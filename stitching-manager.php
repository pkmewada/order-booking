...
<style>
    #refreshStitchingBtn { background-color: #161617 !important; border-color: #161617 !important; color: #fff !important; }
    #refreshStitchingBtn:hover { background-color: #2b2b2d !important; border-color: #2b2b2d !important; }
    ...
    #outsourceList td, #outsourceList th { vertical-align: middle !important; }
    ...
    /* Bulk type toggle */
    .bulk-type-select { min-width: 100px; }
</style>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered text-nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Batch ID</th><th>Sub-Batch</th><th>Brand</th><th>Piece Type</th><th>Firm</th>
                                        <th>Quantity</th><th>Progress</th><th>Damage</th><th>Remaining</th>
                                        <th>Priority</th><th>Delivery Date</th><th>Status</th><th>Actions</th>
                                    </tr>
                                </thead>
