...
<style>
    ...
    .pagination-wrap .pager .page-btn:hover:not(:disabled):not(.active) {
        background: #f4f5f9;
        border-color: #c9d2e3;
    }

    .pagination-wrap .pager .page-btn.active {
        background: #161617;
        color: #fff;
        border-color: #161617;
    }

    .pagination-wrap .pager .page-btn:disabled {
        opacity: .5;
        cursor: not-allowed;
    }
    ...
    #assignRowsContainer .table th,
    .bulk-rows-tbody-parent .table th {
        background: #f8f9fa;
        font-weight: 600;
        font-size: 12px;
    ...
    .status-badge.not_assigned {
        background: #dc3545;
        color: #fff !important;
    }

    .status-badge.assign_progress {
        background: #198754;
        color: #fff !important;
    }
    ...
    .qty-pair .qty-assigned {
        color: #15803d;
        font-weight: 700;
    }

    .qty-pair .qty-assigned.zero {
        color: #9ca3af;
        font-weight: 500;
    }
    ...
    .multi-select-chip .chip-x:hover {
        opacity: 1;
    }
    ...
    .split-row-table tr:last-child td {
        border-bottom: none;
    }

    .split-row-table input,
    .split-row-table select {
        font-size: 12px;
        padding: 4px 8px;
        height: auto;
        max-width: 100%;
    ...
    .split-row-table col.col-sub {
        width: 11%;
    }

    .split-row-table col.col-piece {
        width: 10%;
    }

    .split-row-table col.col-type {
        width: 10%;
    }

    .split-row-table col.col-worker {
        width: 22%;
    }

    .split-row-table col.col-qty {
        width: 9%;
    }

    .split-row-table col.col-priority {
        width: 12%;
    }

    .split-row-table col.col-date {
        width: 21%;
    }

    .split-row-table col.col-copy {
        width: 5%;
    }
    ...
    .bulk-qty-pill.assigned {
        background: #d1fae5;
        color: #065f46;
    }

    .bulk-qty-pill.remaining {
        background: #fef3c7;
        color: #92400e;
    }
        ...
        <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn" id="bulkAssignBtn">
                    <i class="bx bx-layer-plus align-middle me-1"></i> Bulk Assign Stitching
                </button>
                <button class="btn" id="refreshStitchingBtn">
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:100%; width:100%; height:100%; margin:0;">
        <div class="modal-content" style="height:100vh; border-radius:0; border:none;">
            <div class="modal-header py-2">
                <h5 class="modal-title"><i class="bx bx-layer-plus me-1"></i> Bulk Assign Stitching</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3"><label class="form-label">Worker / Firm</label><input type="text" class="form-control" id="progressWorker" readonly></div>
                <div class="row">
...
<div class="modal fade" id="listAllModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width:99vw; width:99vw;">
        <div class="modal-content" style="height:96vh;">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bx bx-list-ul me-1"></i> All Passed Stitching Assignments</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
