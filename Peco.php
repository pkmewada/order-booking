...
<style>
    #refreshPecoBtn { background-color: #161617 !important; border-color: #161617 !important; color: #fff !important; }
    #refreshPecoBtn:hover { background-color: #2b2b2d !important; border-color: #2b2b2d !important; }
        ...
        <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn" id="bulkAssignBtn">
                    <i class="bx bx-layer-plus align-middle me-1"></i> Bulk Assign Peco
                </button>
                <button class="btn" id="refreshPecoBtn">
...
<div class="modal fade" id="bulkAssignModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bx bx-layer-plus me-1"></i> Bulk Assign Peco</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="listAllModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width:99vw; width:99vw;">
        <div class="modal-content" style="height:96vh;">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bx bx-list-ul me-1"></i> All Passed Peco Assignments</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
<script src="assets/js/peco.js"></script>
</body>
</html>