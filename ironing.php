...
<style>
    ...
    .damage-badge {
        display: inline-block; background: #fce4e4; color: #b91c1c;
    ...
    .pagination-wrap .pager .page-btn:hover:not(:disabled):not(.active) {
        background: #f4f5f9; border-color: #c9d2e3;
    }
    .pagination-wrap .pager .page-btn.active {
        background: #161617; color: #fff; border-color: #161617;
    }
    ...
    .qty-pair {
        font-size: 13px; font-weight: 600; color: #18243d; white-space: nowrap;
    }
