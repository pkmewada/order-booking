                ...
                <div class="">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ironing Manager</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="btn-list">
                <button class="btn btn-primary btn-wave me-2" id="addTeamBtn">
                    <i class="bx bx-plus align-middle"></i> Assign Worker
                </button>
            </div>
        </div>
        <!-- Page Header Close -->

        <!-- Ironing Assignments Table -->
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="card-title">
                            <i class="bx bx-group text-success me-2"></i> Ironing Assignments
                            <span class="badge bg-success ms-2" id="teamCount">0</span>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        <div class="row mt-3">
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="card-title">
                            <i class="bx bx-bell text-danger me-2"></i> NOTIFICATION - Ironing Workers
                        </div>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="teamModalLabel">Assign Ironing Worker</h5>
            ...
            <div class="modal-body">
                <form id="teamForm">
                    ...
                    <div id="partAvailabilityInfo"></div>
...
<div class="modal fade" id="progressModal" tabindex="-1" aria-labelledby="progressModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="progressModalLabel">Update Ironing Progress</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="progressForm">
                    <input type="hidden" id="progressWorkerId">
                    <input type="hidden" id="progressBatchId">

                    <div class="mb-3">
                        <label class="form-label">Worker / Batch</label>
                        <input type="text" class="form-control" id="progressWorkerName" readonly>
                    </div>
                    ...
                    <div class="mb-3" id="passSection" style="display: none;">
                        <hr>
                        <label class="form-label text-success">Pass to Next Stage (Packing)</label>
...
<script src="assets/js/ironing-manager.js"></script>